...
export const mockBeneficiarios: Beneficiario[] = [
  {
    ...
    uf: 'SP', localidade: 'São Paulo', numero: '10',
  },
  {
    id: 2, nome: 'Bruno Lima', cpf: '98765432100', dtNasc: '2008-07-22',
    email: 'bruno@email.com', telefone: '11977772222',
    cep: '20040020', logradouro: 'Av. Rio Branco', bairro: 'Centro',
    uf: 'RJ', localidade: 'Rio de Janeiro', numero: '200',
  },
];
...
export const mockDentistas: Dentista[] = [
  {
    ...
    cep: '01310100', logradouro: 'Av. Paulista', bairro: 'Bela Vista',
    uf: 'SP', localidade: 'São Paulo', numero: '1000', complemento: 'Sala 42',
  },
  {
    id: 2, cro: 'CRO-SP 54321', nome: 'Dr. Renato Alves', cpf: '55566677788',
    dtNasc: '1979-11-05', email: 'renato@clinic.com', telefone: '11955552222',
    cep: '01310200', logradouro: 'Av. Paulista', bairro: 'Bela Vista',
    uf: 'SP', localidade: 'São Paulo', numero: '2000',
  },
];

export const mockDoadores: Doador[] = [
  {
    id: 1, nome: 'João Pedro', documanto: '11122233344', dtNasc: '1975-04-18',
    email: 'joao@exemplo.com', telefone: '11944441111',
    cep: '04538133', logradouro: 'Av. Brigadeiro Faria Lima', bairro: 'Itaim Bibi',
    uf: 'SP', localidade: 'São Paulo', numero: '3900',
  },
  {
    id: 2, nome: 'Empresa Sorriso Ltda', documanto: '12345678000199', dtNasc: '2000-01-01',
    email: 'contato@sorriso.com', telefone: '11933332222',
    cep: '04543011', logradouro: 'Rua Funchal', bairro: 'Vila Olímpia',
    uf: 'SP', localidade: 'São Paulo', numero: '418', complemento: '3º andar',
  },
];

export const mockDoacoes: Doacao[] = [
  { id: 1, idDoador: 1, valor: 300.00, descricao: 'Materiais odontológicos' },
  { id: 2, idDoador: 2, valor: 1200.00, descricao: 'Campanha de triagem' },
];
...
export const mockVoluntarios: Voluntario[] = [
  {
    ...
    cep: '30140071', logradouro: 'Av. Afonso Pena', bairro: 'Centro',
    uf: 'MG', localidade: 'Belo Horizonte', numero: '1500',
  ...
  },
  {
    ...
    cep: '01310100', logradouro: 'Av. Paulista', bairro: 'Bela Vista',
    uf: 'SP', localidade: 'São Paulo', numero: '900',
...
export const mockTriagens: Triagem[] = [
  {
    id: 1, idBeneficiario: 1, idVoluntario: 2,
    dataInicio: '2026-05-12', resultado: 'ALTO',
  },
];
...
export const mockDashboardResumo: DashboardResumo = {
  ...
  triagensEmAndamento: mockTriagens.filter((t) => !t.dataFim).length,
};
